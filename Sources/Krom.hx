...
extern class Krom {
	...
	static function setTexture(stage: Dynamic, texture: Dynamic): Void;
	static function setRenderTarget(stage: Dynamic, renderTarget: Dynamic): Void;
	static function setTextureDepth(unit: Dynamic, texture: Dynamic): Void;
	static function setImageTexture(stage: Dynamic, texture: Dynamic): Void;
	static function setTextureParameters(texunit: Dynamic, uAddressing: Int, vAddressing: Int, minificationFilter: Int, magnificationFilter: Int, mipmapFilter: Int): Void;
	static function setTexture3DParameters(texunit: Dynamic, uAddressing: Int, vAddressing: Int, wAddressing: Int, minificationFilter: Int, magnificationFilter: Int, mipmapFilter: Int): Void;
	static function setTextureCompareMode(texunit: Dynamic, enabled: Bool): Void;
	static function setBool(location: Dynamic, value: Bool): Void;
	static function setInt(location: Dynamic, value: Int): Void;
	static function setFloat(location: Dynamic, value: Float): Void;
	static function setFloat2(location: Dynamic, value1: Float, value2: Float): Void;
	static function setFloat3(location: Dynamic, value1: Float, value2: Float, value3: Float): Void;
	static function setFloat4(location: Dynamic, value1: Float, value2: Float, value3: Float, value4: Float): Void;
	static function setFloats(location: Dynamic, values: js.lib.ArrayBuffer): Void;
