...
void iron_app_render(kinc_framebuffer **frames) {
...
void iron_app_render2d(kinc_framebuffer *frame) {
...
void iron_app_notify_on_render(void (*f)(kinc_graphics4 *)) {
	// trait_renders.push(f);
}

void iron_app_remove_render(void (*f)(kinc_graphics4 *)) {
	// trait_renders.remove(f);
}

void iron_app_notify_on_render2d(void (*f)(kinc_graphics2 *)) {
	// trait_renders2d.push(f);
}

void iron_app_remove_render2d(void (*f)(kinc_graphics2 *)) {
