...
function mat3_translation(x: f32, y: f32): Mat3 {
	return mat3_create(
		1, 0, x,
		0, 1, y,
		0, 0, 1
...
function mat3_rotation(alpha: f32): Mat3 {
	return mat3_create(
...
function mat3_multmat(self: Mat3, m: Mat3): Mat3 {
	return mat3_create(
