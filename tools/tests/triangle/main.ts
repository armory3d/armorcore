...
function main() {
	...
	pipeline = krom_g4_create_pipeline();
	...
	let vert: any = krom_g4_create_vertex_shader_from_source(vs);
	let frag: any = krom_g4_create_fragment_shader_from_source(fs);
	...
	ib = krom_g4_create_index_buffer(indices.length);
	let ib_data: u32_array_t = krom_g4_lock_index_buffer(ib);
